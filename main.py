...
if __name__ == '__main__':
    ...
    params = {"model_image_batch_size": 64, "model_image_epoch": 5,
              ...
              "model_mix_batch_size": 32, "model_mix_epoch": 4,
              }
    ...
    mix_model = model_mix.MixedModel.from_pretrain(image_model_path="./data/pretrain_model/image_model",
                                                   voice_model_path="./data/pretrain_model/voice_model")
