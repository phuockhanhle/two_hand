...
if __name__ == '__main__':
    ...
    model_utils.evaluate(voice_model, x_test_voice, y_test_voice)
    ...
    model_utils.train(model=mix_model, x_train=[x_train_voice, x_train_image], y_train=[y_train_voice, y_train_voice],
                      batch_size=32, epochs=10)
